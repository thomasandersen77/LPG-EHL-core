...
echo ""
echo -e "  ${BOLD}2. Start applikasjonen:${NC}"
echo ""
echo -e "     ${BOLD}Field-modus (serialport - ekte eller SOCAT):${NC}"
echo -e "       # Ekte RS-485 port:"
echo -e "       java -jar release/lpg-ehl-webapp.jar \\"
echo -e "         --spring.profiles.active=field \\"
echo -e "         --ehl.serial.port=/dev/ttyUSB0 --ehl.serial.parity=NONE"
echo ""
echo -e "       # Eller via SOCAT virtuell port:"
echo -e "       ./scripts/start-socat-sim.sh    # Start først"
echo -e "       java -jar release/lpg-ehl-webapp.jar \\"
echo -e "         --spring.profiles.active=field \\"
echo -e "         --ehl.serial.port=/tmp/vserial1 --ehl.serial.parity=NONE"
echo ""
echo -e "     ${BOLD}Lab-modus (in-memory emulator - ingen SOCAT):${NC}"
echo -e "       java -jar release/lpg-ehl-webapp.jar \\"
echo -e "         --spring.profiles.active=lab"
echo ""
echo -e "     ${BOLD}Headless (med debug API):${NC}"
