...
/**
 * Transport Configuration for CLI - Dual-Mode Architecture.
 * 
 * Identical to API configuration - ensures CLI and API use same transport logic.
 * 
...
class TransportConfiguration {
    ...
    fun labModeTransport(
        ...
        logger.info("════════════════════════════════════════════════════════")
        logger.info("🔬 LAB MODE ACTIVATED (CLI)")
        logger.info("════════════════════════════════════════════════════════")
    ...
    fun fieldModeTransport(
        ...
        logger.info("════════════════════════════════════════════════════════")
        logger.info("🏭 FIELD MODE ACTIVATED (CLI)")
        logger.info("════════════════════════════════════════════════════════")
    ...
    /**
     * High-level operations service - Shared with API.
     */
    @Bean
    fun ehlOperationsService(communicator: EhlCommunicator): EhlOperationsService {
        logger.info("Creating EhlOperationsService for CLI")
