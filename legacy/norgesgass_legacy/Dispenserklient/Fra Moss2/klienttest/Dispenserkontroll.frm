...
Begin VB.Form Dispenserkontroll 
   ...
   Begin VB.Menu functiondispliter 
      ...
      Begin VB.Menu frigidispliter 
         ...
         Shortcut        =   {F1}
      End
      Begin VB.Menu frigidisp_belop 
         Caption         =   "Frigi dispenser(Beløp)"
         Shortcut        =   {F2}
         Visible         =   0   'False
      End
      Begin VB.Menu settnypris 
         Caption         =   "Sett ny pris"
      End
   End
End
...
If tcpclient.State <> sckConnected Then tcpclient.Connect
...
If tcpclient.State >= 7 Then tcpclient.Close
If Err <> 0 Then MsgBox "Feil ved avslutning av socket.  " & Err.Number & " " & Err.Description
...
Else
cmdstart.Caption = "Frigi dispenser"
bank.Visible = False
