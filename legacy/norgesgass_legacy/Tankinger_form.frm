...
If lpgnorge.rstankinger_pr_dag.State = 1 Then lpgnorge.rstankinger_pr_dag.Close

lpgnorge.tankinger_pr_dag Day(DTPicker1.Value), Month(DTPicker1.Value), Year(DTPicker1.Value)

Set DataGrid1.DataSource = lpgnorge.rstankinger_pr_dag
DataGrid1.Refresh
