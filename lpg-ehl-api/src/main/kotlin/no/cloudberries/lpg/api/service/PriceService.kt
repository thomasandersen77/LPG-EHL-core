...
import no.cloudberries.lpg.api.model.PriceHistory
 ...
 * 4. WebSocket (for real-time GUI oppdatering)
 */
@Service
class PriceService(
    ...
    fun updatePrice(
        ...
        // 3. Broadcast til WebSocket (for /control GUI)
        val priceKr = pricePerLiter.toDouble()
        logWebSocketHandler.broadcastPriceUpdate(priceKr)
        logger.info("📡 WebSocket broadcast sendt til alle klienter")
