...
|-------|-------------|----------|
| **Presentation** | Web controllers, WebSocket handlers | `lpg-ehl-webapp`, `lpg-ehl-app-headless` |
...
graph TD
    ...
    PLSSim[lpg-ehl-serialport-sim<br/>PLS Simulator]
...
| **Java** | 17 | Runtime (per pom.xml; ARK target) |
...
| spring-boot-starter | headless | Core functionality |
...
- Debug API for automation (headless with debug-api profile)
